...
Using Sinatra::Controller has several advantages over a standard Sinatra app:
...
Sinatra::Controller is implemented as a subclass of Sinatra::Base, which
means it is completely compatible with other Sinatra plugins.
